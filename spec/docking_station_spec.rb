...
# below is my verison of the above test - I understand the tutorials, (but I want to know more about lambdas, procs, etc) regardless, I'd like to talk through this in person and see where my thought pattern was misguided. I know its too long etc, but I just want to discuss it - like how can I tell when expect statements are necessary? etc
  ...
  end ## dont really understand this test
